...
ModifierKey = {
    0x1000023: keyboard.Key.alt,
    0x1000003: keyboard.Key.backspace,
    0x1000024: keyboard.Key.caps_lock,
    0x1000022: keyboard.Key.cmd,
    0x1000021: keyboard.Key.ctrl,
    0x1000020: keyboard.Key.shift,
    0x1000007: keyboard.Key.delete,
    0x1000004: keyboard.Key.enter,
    0x1000005: keyboard.Key.enter,
    0x1000000: keyboard.Key.esc,
    0x1000001: keyboard.Key.tab,
    0x20: keyboard.Key.space,
}


class KeyboardModifier(Enum):
    KeyboardModifierMask = -0x2000000
    NoModifier = 0x0
